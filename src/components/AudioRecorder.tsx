        ...
        {!isRecording && !audioBlob && (
          <div className="flex justify-center">
            <button
              ...
              className="inline-flex items-center justify-center px-4 py-2 bg-red-600 hover:bg-red-700 text-white font-medium rounded-lg cursor-pointer transition-colors text-sm w-40"
            >
