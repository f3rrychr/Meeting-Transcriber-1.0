      ...
      <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 sm:p-8 text-center min-h-[400px] flex flex-col justify-center">
        ...
        {!isRecording && !audioBlob && (
          <button
            ...
            className="inline-flex items-center justify-center px-4 py-2 bg-green-600 hover:bg-green-700 text-white font-medium rounded-lg cursor-pointer transition-colors text-sm w-40"
          >
